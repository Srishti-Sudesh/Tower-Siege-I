...
function setup() {
  ...
  block5 = new Block(680,350,40,50);
	...
	block6 = new Block(540,300,40,50);
  block7 = new Block(580,300,40,50);
  block8 = new Block(620,300,40,50);
	block9 = new Block(660,300,40,50);

	block10 = new Block(560,200,40,50);
	block11 = new Block(600,200,40,50);
	block12 = new Block(640,200,40,50);

  block13 = new Block(580,80,40,50);
	block14 = new Block(620,80,40,50);
